...
# Hierarchical cell: const_irq
proc create_hier_cell_const_irq { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_const_irq() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: xlconcat_intr_0, and set properties
  set xlconcat_intr_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 xlconcat_intr_0 ]
  ...
  connect_bd_net -net xlconcat_intr_0_dout [get_bd_pins dout] [get_bd_pins xlconcat_intr_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconcat_intr_0/In0] [get_bd_pins xlconcat_intr_0/In1] [get_bd_pins xlconcat_intr_0/In2] [get_bd_pins xlconcat_intr_0/In3] [get_bd_pins xlconcat_intr_0/In4] [get_bd_pins xlconcat_intr_0/In5] [get_bd_pins xlconcat_intr_0/In6] [get_bd_pins xlconcat_intr_0/In7] [get_bd_pins xlconcat_intr_0/In8] [get_bd_pins xlconcat_intr_0/In9] [get_bd_pins xlconcat_intr_0/In10] [get_bd_pins xlconcat_intr_0/In11] [get_bd_pins xlconcat_intr_0/In12] [get_bd_pins xlconcat_intr_0/In13] [get_bd_pins xlconcat_intr_0/In14] [get_bd_pins xlconcat_intr_0/In15] [get_bd_pins xlconcat_intr_0/In16] [get_bd_pins xlconcat_intr_0/In17] [get_bd_pins xlconcat_intr_0/In18] [get_bd_pins xlconcat_intr_0/In19] [get_bd_pins xlconcat_intr_0/In20] [get_bd_pins xlconcat_intr_0/In21] [get_bd_pins xlconcat_intr_0/In22] [get_bd_pins xlconcat_intr_0/In23] [get_bd_pins xlconcat_intr_0/In24] [get_bd_pins xlconcat_intr_0/In25] [get_bd_pins xlconcat_intr_0/In26] [get_bd_pins xlconcat_intr_0/In27] [get_bd_pins xlconcat_intr_0/In28] [get_bd_pins xlconcat_intr_0/In29] [get_bd_pins xlconcat_intr_0/In30] [get_bd_pins xlconcat_intr_0/In31] [get_bd_pins xlconstant_gnd/dout]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT3_JITTER {90.570} \
   CONFIG.CLKOUT3_PHASE_ERROR {92.673} \
   CONFIG.CLKOUT3_REQUESTED_OUT_FREQ {550} \
   CONFIG.CLKOUT3_USED {true} \
   CONFIG.CLK_OUT1_PORT {clk_out100m} \
   CONFIG.CLK_OUT2_PORT {clk_out275m} \
   CONFIG.CLK_OUT3_PORT {clk_out550m} \
  ...
  # Create instance: const_irq
  create_hier_cell_const_irq [current_bd_instance .] const_irq
  ...
  # Create instance: proc_sys_reset_275m, and set properties
  set proc_sys_reset_275m [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_275m ]

  # Create instance: proc_sys_reset_550m, and set properties
  set proc_sys_reset_550m [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_550m ]
...
Port;FD4A0000;FD4AFFFF;0|FPD;DPDMA;FD4C0000;FD4CFFFF;0|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;87FFFFFFF;1|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1} \
  ...
  connect_bd_net -net clk_wiz_0_clk_out100m [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out100m] [get_bd_pins proc_sys_reset_100m/slowest_sync_clk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk]
  connect_bd_net -net clk_wiz_0_clk_out275m [get_bd_pins clk_wiz_0/clk_out275m] [get_bd_pins proc_sys_reset_275m/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_out550m [get_bd_pins clk_wiz_0/clk_out550m] [get_bd_pins proc_sys_reset_550m/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins proc_sys_reset_100m/dcm_locked] [get_bd_pins proc_sys_reset_275m/dcm_locked] [get_bd_pins proc_sys_reset_550m/dcm_locked]
  connect_bd_net -net proc_sys_reset_100m_peripheral_aresetn [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_100m/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN]
  connect_bd_net -net xlconcat_intr_0_dout [get_bd_pins axi_intc_0/intr] [get_bd_pins const_irq/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins clk_wiz_0/resetn] [get_bd_pins proc_sys_reset_100m/ext_reset_in] [get_bd_pins proc_sys_reset_275m/ext_reset_in] [get_bd_pins proc_sys_reset_550m/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
  ...
  set_property PFM_NAME {xilinx:kv260_som:name:0.0} [get_files [current_bd_design].bd]
  set_property PFM.CLOCK {clk_out100m {id "2" is_default "false" proc_sys_reset "/proc_sys_reset_100m" status "fixed" freq_hz "99999000"} clk_out275m {id "0" is_default "true" proc_sys_reset "/proc_sys_reset_275m" status "fixed" freq_hz "274997250"} clk_out550m {id "1" is_default "false" proc_sys_reset "/proc_sys_reset_550m" status "fixed" freq_hz "549994500"}} [get_bd_cells /clk_wiz_0]
  set_property PFM.AXI_PORT {M01_AXI {memport "M_AXI_GP" sptag "HPM0_LPD" memory "" is_range "false"} M02_AXI {memport "M_AXI_GP" sptag "HPM0_LPD" memory "" is_range "false"} M03_AXI {memport "M_AXI_GP" sptag "HPM0_LPD" memory "" is_range "false"} M04_AXI {memport "M_AXI_GP" sptag "HPM0_LPD" memory "" is_range "false"} M05_AXI {memport "M_AXI_GP" sptag "HPM0_LPD" memory "" is_range "false"} M06_AXI {memport "M_AXI_GP" sptag "HPM0_LPD" memory "" is_range "false"} M07_AXI {memport "M_AXI_GP" sptag "HPM0_LPD" memory "" is_range "false"} M08_AXI {memport "M_AXI_GP" sptag "HPM0_LPD" memory "" is_range "false"}} [get_bd_cells /ps8_0_axi_periph]
  set_property PFM.AXI_PORT {M_AXI_HPM0_FPD {memport "M_AXI_GP" sptag "HPM0_FPD" memory "" is_range "false"} M_AXI_HPM1_FPD {memport "M_AXI_GP" sptag "HPM1_FPD" memory "" is_range "false"} S_AXI_HPC0_FPD {memport "S_AXI_HP" sptag "HPC0" memory "" is_range "false"} S_AXI_HPC1_FPD {memport "S_AXI_HP" sptag "HPC1" memory "" is_range "false"} S_AXI_HP0_FPD {memport "S_AXI_HP" sptag "HP0" memory "" is_range "false"} S_AXI_HP1_FPD {memport "S_AXI_HP" sptag "HP1" memory "" is_range "false"} S_AXI_HP2_FPD {memport "S_AXI_HP" sptag "HP2" memory "" is_range "false"} S_AXI_HP3_FPD {memport "S_AXI_HP" sptag "HP3" memory "" is_range "false"}} [get_bd_cells /zynq_ultra_ps_e_0]
